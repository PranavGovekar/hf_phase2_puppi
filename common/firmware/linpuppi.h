...
packed_linpuppi_refobj packed_linpuppi_prepare_track(const ap_uint<l1ct::TkObj::BITWIDTH_SLIM> & track, const l1ct::z0_t & pvZ0);
...
#define LINPUPPI_FWD_DR2MAX  4727 // 0.3 cone
#define LINPUPPI_FWD_DR2MIN    84 // 0.04 cone
#define LINPUPPI_FWD_dzCut     40 // unused
#define LINPUPPI_FWD_iptMax    200 // 50.0/LINPUPPI_ptLSB 

#define LINPUPPI_FWD_ptSlopeNe  0.3
#define LINPUPPI_FWD_ptSlopePh  0.4
#define LINPUPPI_FWD_ptZeroNe   9.0
#define LINPUPPI_FWD_ptZeroPh   5.0
#define LINPUPPI_FWD_alphaSlope 2.2
#define LINPUPPI_FWD_alphaZero  9.0
#define LINPUPPI_FWD_alphaCrop  4.0
#define LINPUPPI_FWD_priorNe    7.0
#define LINPUPPI_FWD_priorPh    5.0

#define LINPUPPI_FWD_ptCut      4.0
